...
const AddProductScreen = ({ catalog, loading = false, saving = false, disabled = false, syncError, onCancel, onSave, onRetry }: Props) => {
  ...
  return <SafeAreaView style={styles.screen} edges={['top', 'bottom']}>
    ...
    <ScrollView style={styles.scroll} contentContainerStyle={styles.content} keyboardShouldPersistTaps="handled">
      ...
      <Text style={styles.label}>Selling Price</Text><View style={styles.inputRow}><TextInput style={styles.inputFlex} value={price} onChangeText={setPrice} keyboardType="decimal-pad" placeholder="Enter price" placeholderTextColor={colors.textMuted} /><Ionicons name="cash-outline" size={21} color={colors.textMuted} /></View>
